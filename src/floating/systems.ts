import { Anchor, Float } from './traits.js';
...
import { Letter } from '../letter/traits.js';
import { Package } from '../package/traits.js';
import { Profile } from '../profile/traits.js';
...
export function floatBodies(world: World) {
  ...
  world
    .query(Position, Rotation, Anchor, Float, Not(IsHidden))
